...
import { StyleSheet, TextInput, Text, View, Image, Button, TouchableOpacity, ScrollView, Alert, FlatList, Linking, RefreshControl } from 'react-native'
...
class Giaovat extends Component {
    ...
    confixTime = (pDate) => {
        ...
        if (pDate != undefined) {
            ...
            let ddmm = pDate.slice(0, 5);
            let ddmmyy = pDate.slice(0, 10)
    ...
    render() {
        ...
        return (
            <ScrollView style={{ marginBottom: Platform.OS == 'ios' ? sizeHeight(12) : sizeHeight(32) }}
                refreshControl={
                    <RefreshControl
                                        ...
                                        <View style={{ flexDirection: 'row', alignItems: 'center', borderTopWidth: 1, borderTopColor: '#999999', paddingTop: 10 }}>
                                            ...
                                            <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => navigation.navigate("comment", {
                                                ...
                                                <Image
                                                    ...
                                                    style={{ width: 23, height: 23, marginRight: 8, justifyContent: 'center', alignItems: 'center' }}
                                                />
